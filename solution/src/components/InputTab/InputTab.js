      ...
      <React.Fragment>
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link" id="json-tab" data-toggle="tab" href="#" role="tab" aria-controls="json-content" aria-selected="true"
              onClick={() => changeTab('ui', 'json')}
            >Via JSON</a>
            <a class="nav-item nav-link active" id="ui-tab" data-toggle="tab" href="#" role="tab" aria-controls="ui-content" aria-selected="false"
              onClick={() => changeTab('json', 'ui')}
            >Via UI</a>
          </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="json-content" role="tabpanel" aria-labelledby="nav-json-tab"><InputJSON></InputJSON></div>
          <div class="tab-pane fade" id="ui-content" role="tabpanel" aria-labelledby="nav-ui-tab"><InputUI></InputUI></div>
        </div>
      </React.Fragment>
    );
  }
